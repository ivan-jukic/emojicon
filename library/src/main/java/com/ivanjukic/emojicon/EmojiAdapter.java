...
import com.ivanjukic.emojicon.viewElements.EmojiconTextView;


public class EmojiAdapter extends ArrayAdapter<Emojicon> {
    private boolean mUseSystemDefault = false;
    EmojiconPopupGridView.OnEmojiconClickedListener emojiClickListener;
    ...
    public void setEmojiClickListener(EmojiconPopupGridView.OnEmojiconClickedListener listener){
