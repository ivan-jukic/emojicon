...
package com.ivanjukic.emojicon.slidingTab;
...
import com.ivanjukic.emojicon.adapters.EmojiconPagerAdapterInterface;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private void populateTabStrip() {
        if (this.isPopup) {
            final EmojiconPopupPagerAdapter adapter = (EmojiconPopupPagerAdapter)mViewPager.getAdapter();
            populateTabStripWithAdapter(adapter);
        } else {
            final EmojiconFragmentPagerAdapter adapter = (EmojiconFragmentPagerAdapter)mViewPager.getAdapter();
            populateTabStripWithAdapter(adapter);
        }
    }

    private <E extends EmojiconPagerAdapterInterface> void populateTabStripWithAdapter(E adapter) {
    ...
    /**
     * If we should handle popup sliding tab
     * @param isPopup - true / false
     */
